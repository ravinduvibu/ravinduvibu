...
- DevOps: Docker, Linux, CI/CD, AWS, GCP  

> My strength is building **complete AI products** — from model → API → frontend → deployment.
...
I'm always learning, experimenting, and shipping.
